<template>
  <div>
    ...
    <section id="postContent">
      ...
      <img
        v-if="this.newPost.urlImage !== ''"
        v-bind:src="this.newPost.urlImage"
      />
      <form v-on:submit.prevent="submitPost">
        ...
        <textarea
          ...
          type="text"
          v-model="newPost.postDescription"
        />
    ...
    handleErrorResponse(error, verb) {
      if (error.response) {
        this.errorMsg =
          "Error " +
          verb +
          " post. Response received was '" +
          error.response.statusText +
          "'.";
      } else if (error.request) {
        this.errorMsg = "Error " + verb + " post. Server could not be reached.";
      } else {
        this.errorMsg =
